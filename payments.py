...
class PaymentHandler:
    ...
    #                 str(1 if payment["values"][7] == "" else payment["values"][7])
    #             )
    ...
    #                     self.total_payments += string_to_float(amount)
    #                     self.dollars_payments += string_to_float(amount)
    #                 self.total_payments_dollars_label["text"] = (
    #                     number_to_str(self.dollars_payments) + "$"
    #                 )
    #             else:
    #                 if pay_type == "Pago":
    ...
    #                     self.total_payments += string_to_float(amount) / rate
    #                     self.bs_payments += string_to_float(amount)
    #                 self.total_payments_bs_label["text"] = (
    #                     number_to_str(self.bs_payments) + "bs"
    #                 )
    ...
    #             if sale_id:
    #                 self.total_payments_dollars_label["text"] = (
    #                     number_to_str(self.total_payments) + "$"
    #                 )
    #             if callbacks:
    ...
    #         frame, text="Pagos", font=("calibri", 15, "bold")
    #     )
    ...
    #         new_payment_window, text=title, font=("calibri", 18, "bold")
    #     )
    #     title_label.grid(row=0, column=0, pady=(0, 30))

    #     # Date.
    #     date_label = tk.Label(new_payment_window, text="Fecha", font=("calibri", 15))
    #     date_label.grid(row=1, column=0, pady=(0, 20), sticky=tk.W)
    #     new_payment_date_entry = ttk.Entry(
    #         new_payment_window, width=10, font=("calibri", 15)
    #     )
    ...
    #     # Currency.
    #     curr_label = tk.Label(new_payment_window, text="Moneda", font=("calibri", 15))
    ...
    #     curr_option = ttk.OptionMenu(new_payment_window, currency, *currency_choices)
    ...
    #         new_payment_window, text="Método Pago", font=("calibri", 15)
    #     )
    ...
    #     method_option = ttk.OptionMenu(new_payment_window, method, *method_choices)
    ...
    #         new_payment_window, text="Cuenta", font=("calibri", 15)
    #     )
    ...
    #     account_option = ttk.OptionMenu(new_payment_window, account, *account_choices)
    #     account_option.grid(row=4, sticky=tk.E, pady=(0, 20))

    #     # Rate
    #     rate_label = tk.Label(
    #         new_payment_window, text="Tasa del día", font=("calibri", 15)
    #     )
    #     rate_label.grid(row=5, column=0, sticky=tk.W, pady=(0, 20))
    #     rate_entry = ttk.Entry(new_payment_window, width=13, font=("calibri", 15))
    #     rate_entry.insert(0, rate)
    #     rate_entry.grid(row=5, column=0, sticky=tk.E, pady=(0, 20))

    #     # Amount
    #     amount_label = tk.Label(new_payment_window, text="Monto", font=("calibri", 15))
    #     amount_label.grid(row=6, pady=(0, 20), sticky=tk.W)
    #     amount_entry = ttk.Entry(new_payment_window, width=13, font=("calibri", 15))
    #     amount_entry.focus()
    ...
    #                 if not (rate_entry.get()) or (
    #                     string_to_float(rate_entry.get()) == 0
    #                 ):
    ...
    def display_total_payments(self, frame, is_detail=False):
        ...
        total_payments_label = tk.Label(
            frame, text="Pagos:", font=("calibri", 17, "bold")
        )
        total_payments_label.grid(row=1, column=1, pady=20, sticky=tk.W)
        self.total_payments_dollars_label = tk.Label(
            frame, text="{}$".format(self.total_payments), font=("calibri", 17, "bold")
        )
        self.total_payments_dollars_label.grid(
            row=1, column=2, pady=20, padx=10, sticky=tk.E
        )
