...
class SaleTotalFrame:
    def __init__(self, parent, rate_entry: ttk.Entry, orders_handler: OrderHandler, payments_handler: PaymentHandler) -> None:
        ...
        self.remaining_handler = SaleTotalRamaining(remaining_frame, self.rate_entry, self.orders_handler, self.payments_handler)
